...
---
Main Promts:
**Prompt**: "I want to make a website with a frontend and backend. It will be two or more chatbots talking to each other. The backend will be able to access API for a language learning model (or something) but not the front end. The user using the website will be able to make the set the idedntity of the chatbots to be any expert with puplications. give me the protocol to set up the backend"

**Prompt**:"ok I want this to be a website where users look up the experts, and are able to set the chatbots to be those experts. I also want the chatbots to display figures from their data to support their reasoning."

**Prompt**:"its live now help me build a nice professional looking front end: the chats on either side of the screen, the evidence.graphs in the middle"

The rest of the promts were a cycle of copying and pasting various errors into the chat.
## 2. Backend Setup
...
Summary of interactions with copilot (generated by partially by copilot)

### What Was Requested

"i want to make sure [app.py] is working properly"
